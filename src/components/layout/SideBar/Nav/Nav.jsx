function Nav(){
    ...
    <>
      <nav class="sidebar-nav">
        <a href="dashboard.html" class="nav-item active"><span class="icon" data-icon="layoutDashboard">
          ...
          </span><span class="nav-label">Dashboard</span></a>
        <a href="my-tasks.html" class="nav-item"><span class="icon" data-icon="listTodo">
        ...
        <a href="projects.html" class="nav-item"><span class="icon" data-icon="folderKanban">
          ...
          </span><span class="nav-label">Projects</span></a>
        <a href="members.html" class="nav-item"><span class="icon" data-icon="users">
          ...
          </span><span class="nav-label">Members</span></a>
        <p class="sidebar-section-label">Admin</p>
        <a href="admin-users.html" class="nav-item"><span class="icon" data-icon="shieldCheck">
          <svg viewBox="0 0 24 24"><path d="M20 13c0 5-3.5 7.5-7.66 8.95a1 1 0 0 1-.67-.01C7.5 20.5 4 18 4 13V6a1 1 0 0 1 1-1c2 0 4.5-1.2 6.24-2.72a1.17 1.17 0 0 1 1.52 0C14.51 3.81 17 5 19 5a1 1 0 0 1 1 1z"></path><path d="m9 12 2 2 4-4"></path></svg></span><span class="nav-label">Users</span></a>
        <a href="admin-moderation.html" class="nav-item"><span class="icon" data-icon="flag">
          ...
          </span><span class="nav-label">Moderation</span></a>
      </nav>
        </>
    )
}
